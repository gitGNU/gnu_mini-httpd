 ...
 *  proposed his logging library <http://www.torjo.com/> to boost.org, but
 *  unfortunately couldn't get consent to have it accepted. For the time being,
 *  mini-httpd relies on his code for both tasks, because the library offers a
 *  lot of ready-to-go functionality, including support for rotating log file,
 *  message timestamping, etc.
 *
