...
// Buffer sizes.
unsigned int configuration::read_block_size             = 16 kb;
unsigned int configuration::min_buffer_fill_size        =  4 kb;
unsigned int configuration::max_buffer_fill_size        = 32 kb;
